# Transmission Layer — board brief · 2026-09-03 23:23Z

data as of **2026-09-03** · 98 series · 6 red / 46 amber · 8 events surfaced (36 suppressed)
...
- FDR (BH q=0.1): **1 of 90** scanned series survive multiplicity control (effective p ≤ 2.9518609778733662e-12)
- **SETUP** dxy → eur_usd: leads 1d (ccf -0.836, β -0.9039, p 0.0); driver zc -1.64 → expected 0.506%. Type hit-rate 0.829 (n=1971).
- **SETUP** dxy → gbp_usd: leads 1d (ccf -0.726, β -0.7802, p 0.0); driver zc -1.64 → expected 0.437%. Type hit-rate 0.829 (n=1971).
...
### [RED 6.88] usd_jpy ↓
- usd_jpy [FX]: last 155.99, z20 -4.88, zc -5.67, resid-z -6.98 [unexplained], 1d -2.62%, |z20|=4.88
...
- dow_jones [INDICES]: last 53687.54, z20 0.54, zc 1.57, resid-z 0.79 [priced], 1d 1.18%, 1y-pct=96
...
### [AMBER 5.17] commodities · 2 series ↑
- wti [COMMODITIES]: last 91.84, z20 2.34, zc 0.35, resid-z 0.54 [quiet], 1d 0.91%, |z20|=2.34
- brent [COMMODITIES]: last 95.89, z20 1.82, zc 0.11, resid-z 0.37 [quiet], 1d 0.27%, |z20|=1.82
- **Mechanism**: commodities · 2 series ↑: correlated cluster flagged by the engine. Mechanism narrative unassessed (LLM off). Nearest historical analogue: 2026-05-22 (z-distance 0.0).
- **Gap**: Unassessed (LLM off) — laggard list above is the live math.
- **India take**: No exposed Indian receivers above the correlation floor.
- Watch next: dow_jones (inverse) — not yet - watch; rho -0.665 vs wti
- Source: Why Oil Majors Don’t Want to Build New U.S. Refineries — OilPrice, 2026-09-03. https://oilprice.com/Energy/Crude-Oil/Why-Oil-Majors-Dont-Want-to-Build-New-US-Refineries.html
...
nifty_50 ↓ (4.12), midcap_largecap_ratio ↑ (3.97), nikkei_225 ↓ (3.92), usd_inr ↓ (3.81), dyn_nvda ↑ (3.75), gold_silver_ratio ↓ (3.69), natgas ↑ (3.52), dyn_tech ↑ (3.3), dyn_atherenerg_ns ↑ (3.29), bovespa ↑ (2.62), fx · 2 series ↑ (2.62), indices · 2 series ↓ (2.49)

## India macro
- nifty_50: 23873.4492 (1d -0.17%, z20 -2.12, flag amber)
- nifty_midcap_100: 63235.8984 (1d 0.36%, z20 -1.64, flag amber)
- usd_inr: 94.4877 (1d -0.49%, z20 -1.81, flag amber)
...
- INOXINDIA.NS (INOX INDIA LIMITED) score 81.0 — "Indian Energy Exchange records highest-ever monthly electricity volume in August"
- COALINDIA.NS (COAL INDIA LTD) score 79.2 — "Indian Energy Exchange records highest-ever monthly electricity volume in August"
- HAVELLS.NS (HAVELLS INDIA LIMITED) score 77.6 — "Indian Energy Exchange records highest-ever monthly electricity volume in August"
- INDIANB.NS (INDIAN BANK) score 76.4 — "HSBC HIKES TREASURY YIELD FORECASTS HSBC raised its U.S. Treasury yield forecasts as the F"
- BAC (Bank of America Corporation) score 66.1 — "Oura files for IPO amid Americans’ obsession with tracking their sleep, steps and heart ra"
- HDB (HDFC Bank Limited) score 57.2 — "HSBC HIKES TREASURY YIELD FORECASTS HSBC raised its U.S. Treasury yield forecasts as the F"
- COIN (Coinbase Global, Inc.) score 56.4 — "UK Borrowing Costs Surge as Oil Shock Rattles Global Markets"
- BOND (PIMCO Active Bond Exchange-Tra) score 55.7 — "Wall Street is betting on Fed Chair Kevin Warsh to keep a manic bond market from unravelin"
- IDBI.NS (IDBI BANK LIMITED) score 55.1 — "HSBC HIKES TREASURY YIELD FORECASTS HSBC raised its U.S. Treasury yield forecasts as the F"
- INDUSINDBK.BO (INDUSIND BANK LTD.) score 55.1 — "HSBC HIKES TREASURY YIELD FORECASTS HSBC raised its U.S. Treasury yield forecasts as the F"
- KARURVYSYA.NS (KARUR VYSYA BANK LTD) score 55.1 — "HSBC HIKES TREASURY YIELD FORECASTS HSBC raised its U.S. Treasury yield forecasts as the F"
- CHKP (Check Point Software Technolog) score 40.9 — "High conviction picks: Up to 44% upside - 5 large caps, 9 mid and small caps stocks | Chec"
- TECHM.NS (TECH MAHINDRA LIMITED) score 35.4 — "Nvidia takes back control of the AI trade as Big Tech nears record highs"
- CARTRADE.NS (CARTRADE TECH LIMITED) score 35.1 — "Nvidia takes back control of the AI trade as Big Tech nears record highs"
- TECH (Bio-Techne Corp) score 35.1 — "Nvidia takes back control of the AI trade as Big Tech nears record highs"
- OHI (Omega Healthcare Investors, In) score 34.9 — "This subtle Microsoft change could be a big win for investors"
- LTH (Life Time Group Holdings, Inc.) score 29.1 — "TRUMP’S THURSDAY SCHEDULE 🔸 8:00 AM — Executive Time 🔸 11:00 AM — Intelligence Briefing 🔸 "
- 301077.SZ (CHINASTARS) score 26.8 — "CHINA AND RUSSIA PUSH FOR DEEPER INVESTMENT TIES China is ready to expand investment coope"
- ATHERENERG.NS (ATHER ENERGY LIMITED) score 22.5 — "Indian Energy Exchange records highest-ever monthly electricity volume in August"
- PCJEWELLER.NS (PC JEWELLER LTD) score 17.9 — "Deepa Jewellers IPO Day 3: GMP falls to 13%, issue booked 42x"
- NVDA (NVIDIA Corporation) score 17.3 — "Nvidia takes back control of the AI trade as Big Tech nears record highs"
- JIOFIN.BO (Jio Financial Services Limited) score 15.8 — "FED'S WALLER SAYS MORTGAGE RATES, AUTO LOAN RATES ARE NOT LOW FED'S WALLER SAYS 'LOOSE FIN"
- STYLEBAAZA.NS (BAAZAR STYLE RETAIL LTD) score 14.6 — "Retail sugar price drops 3.85% to ₹62.57/kg in a week: Govt data"
- MUTHOOTFIN.NS (MUTHOOT FINANCE LIMITED) score 10.6 — "Bajaj Finance Share Price Live Updates: Bajaj Finance Price Decline Report"
- BHARATCOAL.NS (BHARAT COKING COAL LTD) score 10.6 — "PTC India, Coal India among 10 stocks offering dividend yields of up to 10%"
- JUSTDIAL.BO (JUST DIAL LTD.) score 10.0 — "TRUMP: I JUST WANT THE WAR ENDED IN UKRAINE"
...
- VT (Vanguard Total World Stock Ind) score 7.8 — "Jindal Worldwide stock hits upper circuit - What's behind the share price jump?"
- META (Meta) score 7.2 — "Gold vs Silver: Which precious metal offers a better bet for investors after the recent co"
- TATAELXSI.NS (TATA ELXSI LIMITED) score 7.0 — "16% jump in share price of this firm after  ₹100 crore order from Tata Motors PV | Do you "
...
- LENSKART.NS (LENSKART SOLUTIONS LTD) score 2.5 — "Lenskart shares to rally 40%? Nomura initiates coverage with Buy, says its growth journey "
