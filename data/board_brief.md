# Transmission Layer — board brief · 2026-08-12 22:09Z

data as of **2026-08-12** · 98 series · 12 red / 31 amber · 8 events surfaced (20 suppressed)
...
- FDR (BH q=0.1): **1 of 89** scanned series survive multiplicity control (effective p ≤ 1.1185008474967617e-10)
- **SETUP** dyn_crwv → taiwan_weighted: leads 1d (ccf 0.317, β 0.0759, p 0.00018); driver zc 3.21 → expected 1.459%. Type hit-rate 0.815 (n=2503).
- Track record · residual_reversion: hit-rate **0.493** (n=1125) — |resid_z|>=2.0 -> fwd 5d return opposes residual
...
- comex_gold [COMMODITIES]: last 4469.00, z20 2.88, zc 1.21, resid-z 0.33 [quiet], 1d 1.96%, |z20|=2.88; co-occur[gold_silver] same-direction (channel VALID)
- comex_silver [COMMODITIES]: last 65.53, z20 2.34, zc 0.45, resid-z -0.98 [quiet], 1d 1.17%, |z20|=2.34; co-occur[gold_silver] same-direction (channel VALID)
...
- stoxx_50 [INDICES]: last 6530.18, z20 1.53, zc -0.41, resid-z -0.73 [quiet], 1d -0.32%, |z20|=1.53; 1y-pct=99
- sp500 [INDICES]: last 7748.71, z20 1.47, zc 0.32, resid-z -1.19 [quiet], 1d 0.27%, 1y-pct=99
- dax [INDICES]: last 26339.76, z20 1.44, zc -0.26, resid-z -0.27 [quiet], 1d -0.20%, 1y-pct=99
- gold_silver_ratio [DERIVED]: last 68.20, z20 -1.15, zc n/a, resid-z n/a [quiet], 1d 0.78%, GSR<75 (extreme low)
- comex_copper [COMMODITIES]: last 6.61, z20 1.13, zc -0.03, resid-z -0.09 [quiet], 1d -0.06%, 1y-pct=97
- cac_40 [INDICES]: last 8665.15, z20 1.13, zc -0.79, resid-z -1.01 [quiet], 1d -0.57%, 1y-pct=97
- dow_jones [INDICES]: last 53769.86, z20 1.11, zc -0.05, resid-z -0.62 [quiet], 1d -0.04%, 1y-pct=97
- **Mechanism**: The recent move in US stocks, driven by strong AI infrastructure company earnings and mild inflation data, has led to a rise in risk-on sentiment. This sentiment is propagated through the VALID vix_equity_inverse channel, where a vol spike leads to an equity drawdown, but in this case, the vol is down and equities are up. The VALID gold_silver_comove channel also supports this move, as monetary metals co-move and the gold-silver ratio is at an extreme low.
- **Gap**: No gap: the big raw move in US stocks is largely priced, with small resid_z values indicating that the move is explained by factor exposures.
- **India take**: The Indian instrument nifty_midcap_100 has already reacted to the move in dax, while nifty_fmcg has reacted to the move in dyn_nvda. The nifty_50 is still quiet and worth watching.
- Watch next: nifty_midcap_100 (up) — already moved; reacted to dax move
- Watch next: nifty_fmcg (down) — already moved; reacted to dyn_nvda move
- Watch next: nifty_50 (up) — not yet - watch; quiet despite positive sentiment
- **India receivers**: nifty_midcap_100 (rho 0.512, z 1.79); nifty_fmcg (rho -0.509, z -1.82); nifty_50 (rho 0.488, z 0.52); nifty_metal (rho 0.48, z 1.46)
- Source: Goldman’s latest deal underscores how ‘boomer candy’ ETFs are now big business on Wall Street — MarketWatch Top, 2026-08-12. https://www.marketwatch.com/story/goldmans-latest-deal-underscores-how-boomer-candy-etfs-are-now-big-business-on-wall-street-5520109d?mod=mw_rss_topstories
...
### [RED 5.82] corn ↑
- corn [COMMODITIES]: last 481.00, z20 3.82, zc 8.10, resid-z 6.45 [unexplained], 1d 10.13%, |z20|=3.82; 1y-pct=100
- **Mechanism**: The corn price surge is driven by a supply shock, as the USDA's unexpected yield cut amid heat waves has led to a sharp increase in prices. This move is likely to propagate through the metal_copper_channel, given the historical correlation between global copper prices and Indian metal equities. The RISK_ON regime and VALID gold_silver_comove channel also suggest that the market is positioned for further risk-on moves.
- **Gap**: No gap: the big raw move in corn with a resid_z of 6.45 is largely unexplained by factors, but given the explicit news-driven supply shock, this move is PRICED, not an anomaly.
- **India take**: The Indian instrument that expresses this move is likely to be the MCX Copper futures, which may react positively to the global copper price move. However, the reaction is yet to be seen as the inr_oil_channel and dxy_inr_channel are WEAK, reducing the transmission efficacy.
...
dyn_ohi ↓ (4.44), dyn_atherenerg_ns ↑ (4.41), usd_brl ↑ (3.71), shanghai_comp ↑ (3.59), fx · 2 series ↑ (3.5), dyn_tech ↑ (3.46), dyn_tatatech_ns ↑ (3.41), bovespa ↓ (3.1), dyn_coin ↓ (3.02), dyn_hdb ↓ (2.92), usd_cny ↓ (2.65), dyn_indianb_ns ↑ (2.46)
...
- COALINDIA.NS (COAL INDIA LTD) score 87.6 — "Nippon India launches Income Plus Arbitrage Omni Fund of Fund"
- INOXINDIA.NS (INOX INDIA LIMITED) score 87.2 — "Nippon India launches Income Plus Arbitrage Omni Fund of Fund"
- HAVELLS.NS (HAVELLS INDIA LIMITED) score 86.7 — "Nippon India launches Income Plus Arbitrage Omni Fund of Fund"
- INDIANB.NS (INDIAN BANK) score 66.1 — "SPCX - NORGES BANK REPORTS SHARE STAKE OF 7.3 MLN CLASS A SHARES IN SPACEX - SEC FILING"
- BAC (Bank of America Corporation) score 54.6 — "UKRAINIAN DRONES OVERWHELM U.S. FORCES IN WAR GAME Ukrainian drone operators overwhelmed U"
- TECHM.NS (TECH MAHINDRA LIMITED) score 53.6 — "Q1 Results Today Highlights: Tata Motors, HAL, Grasim Industries, Eureka Forbes, Lenskart,"
- CARTRADE.NS (CARTRADE TECH LIMITED) score 52.8 — "Q1 Results Today Highlights: Tata Motors, HAL, Grasim Industries, Eureka Forbes, Lenskart,"
- TECH (Bio-Techne Corp) score 51.9 — "Q1 Results Today Highlights: Tata Motors, HAL, Grasim Industries, Eureka Forbes, Lenskart,"
- OHI (Omega Healthcare Investors, In) score 51.3 — "Investors are chasing the latest rally in gold as the yellow metal hits strongest level in"
- HDB (HDFC Bank Limited) score 49.0 — "SPCX - NORGES BANK REPORTS SHARE STAKE OF 7.3 MLN CLASS A SHARES IN SPACEX - SEC FILING"
- COIN (Coinbase Global, Inc.) score 47.9 — "Refinery Attacks Deepen Global Diesel Supply Crunch"
- IDBI.NS (IDBI BANK LIMITED) score 45.0 — "SPCX - NORGES BANK REPORTS SHARE STAKE OF 7.3 MLN CLASS A SHARES IN SPACEX - SEC FILING"
- INDUSINDBK.BO (INDUSIND BANK LTD.) score 45.0 — "SPCX - NORGES BANK REPORTS SHARE STAKE OF 7.3 MLN CLASS A SHARES IN SPACEX - SEC FILING"
- KARURVYSYA.NS (KARUR VYSYA BANK LTD) score 44.7 — "SPCX - NORGES BANK REPORTS SHARE STAKE OF 7.3 MLN CLASS A SHARES IN SPACEX - SEC FILING"
- CHKP (Check Point Software Technolog) score 42.0 — "Shiprocket IPO Day 1: Issue subscribed 97% so far. GMP hints 31% listing pop. Check review"
- LTH (Life Time Group Holdings, Inc.) score 36.3 — "SAUDI SUPERTANKER RETURNS TO KEY OIL TERMINAL A supertanker has been spotted at Saudi Arab"
- ATHERENERG.NS (ATHER ENERGY LIMITED) score 32.9 — "ENERGY COULD REIGNITE INFLATION IN AUGUST Falling energy prices helped cool July inflation"
- 301077.SZ (CHINASTARS) score 25.8 — "Now China wants to become the shop floor for the Muslim world"
- TATAELXSI.NS (TATA ELXSI LIMITED) score 25.0 — "From Trent to Titan: Over 15 Tata Group stocks more than doubled investors' wealth during "
- BOND (PIMCO Active Bond Exchange-Tra) score 23.6 — "Axis Bank raises $300 million via bonds"
- TATATECH.NS (TATA TECHNOLOGIES LIMITED) score 19.3 — "From Trent to Titan: Over 15 Tata Group stocks more than doubled investors' wealth during "
- MUTHOOTFIN.NS (MUTHOOT FINANCE LIMITED) score 18.5 — "Quote of the day by Richard Thaler: "If we use prediction as the measure of a model, tradi"
- JUSTDIAL.BO (JUST DIAL LTD.) score 15.2 — "Miss just 5 best days of Nifty and lose big: How 21-year data from 2005-2026 shows cost of"
- JIOFIN.BO (Jio Financial Services Limited) score 14.9 — "US Sells 10-Year Debt at Highest Yields Since Financial Crisis"
- MS (Morgan Stanley) score 14.1 — "SPCX - MORGAN STANLEY: SPACEX LOCK-UP IS A BUYING OPPORTUNITY Morgan Stanley reiterated Ov"
- HDBFS.BO (HDB FINANCIAL SERVICES LIMITED) score 12.7 — "US Sells 10-Year Debt at Highest Yields Since Financial Crisis"
- BHARATCOAL.NS (BHARAT COKING COAL LTD) score 12.2 — "After Mahanadi, Coal India's SECL invites banker pitches for proposed  ₹10,000 crore IPO"
- NVDA (NVIDIA Corporation) score 12.1 — "Alphabet’s stock slips as Nvidia’s $500 billion financing deal threatens custom chips"
- PCJEWELLER.NS (PC JEWELLER LTD) score 10.5 — "Motilal Oswal bullish on jewellery stocks; picks Titan, Kalyan Jewellers as top bets, sees"
- AAPL (Apple Inc.) score 8.4 — "Nvidia, Apple, Google fuel record $185 billion gain for Norway’s wealth fund, but CEO say,"
- BHARATFORG.BO (BHARAT FORGE LTD.) score 8.4 — "ideaForge Technology shares drop over 9% in two days. JM Financial downgrades rating"
- META (Meta) score 7.5 — "Investors are chasing the latest rally in gold as the yellow metal hits strongest level in"
- VT (Vanguard Total World Stock Ind) score 7.1 — "Now China wants to become the shop floor for the Muslim world"
- ADANIENT.BO (ADANI ENTERPRISES LTD.) score 5.3 — "QIP fundraising hits one-year high, Adani firms dominate"
- INTC (Intel Corporation) score 5.1 — "Nvidia, Intel, Google: Wall Street is partying like it’s 1999"
- ICICIGI.BO (ICICI Lombard General Insuranc) score 3.5 — "ICICI Bank Share Price Live Updates: ICICI Bank Stock Details"
- GS (Goldman Sachs Group, Inc. (The) score 2.9 — "Goldman’s latest deal underscores how ‘boomer candy’ ETFs are now big business on Wall Str"
- CRWV (CoreWeave, Inc.) score 2.7 — "US stocks: S&P 500 ends higher as CoreWeave results fuel AI optimism"
- FINCABLES.NS (FINOLEX CABLES LTD) score 2.6 — "Finolex Cables ends 6% higher after Q1 results, Jefferies lift target to ₹1,410"
