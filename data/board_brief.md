...
- dyn_kalyankjil_ns [EQUITIES]: last 480.20, z20 5.70, 1d 8.40%, |z20|=5.70
...
- tips_10y_real [RATES]: last 2.31, z20 1.83, 1d 0.00%, |z20|=1.83; 1y-pct=99
- ust_30y [RATES]: last 5.05, z20 1.68, 1d -0.20%, |z20|=1.68; 1y-pct=96
- ust_10y [RATES]: last 4.54, z20 1.29, 1d -0.44%, 1y-pct=95
- ust_2y [RATES]: last 4.16, z20 0.50, 1d -1.19%, 1y-pct=96
...
- Source: India's 10-year bond logs best day in over a week on oil relief — BusinessLine Mkts, 2026-07-10. https://www.thehindubusinessline.com/markets/indias-10-year-bond-logs-best-day-in-over-a-week-on-oil-relief/article71206420.ece
- Source: US Stock Market: Treasury yields ease as investors buy bonds after selloff; strong auction boosts sentiment — ET Markets, 2026-07-10. https://economictimes.indiatimes.com/markets/us-stocks/news/us-stock-market-treasury-yields-ease-as-investors-buy-bonds-after-selloff-strong-auction-boosts-sentiment/articleshow/132303499.cms
- Historical analogues: 2026-05-22 (d=0.0), 2026-05-07 (d=0.26), 2026-05-14 (d=0.57)

### [RED 5.48] natgas ↓
- natgas [COMMODITIES]: last 2.95, z20 -3.48, 1d -2.12%, |z20|=3.48
- **Mechanism**: The recent decline in natgas prices may propagate through the energy market, potentially affecting the stock prices of natural gas companies and the overall energy sector. This is due to the decrease in LNG imports and higher gas procurement costs triggered by the West Asia conflict. The order for new LNG carriers by ADNOC may also impact the global LNG market, influencing natgas prices.
- **Gap**: No gap: The decline in natgas prices is already reflected in the market, with historical analogues indicating a potential rebound.
- **India take**: Indian natural gas companies, such as those listed on the NSE or BSE, may react to the decline in natgas prices, particularly if they have exposure to global LNG markets. However, the reaction may be muted due to the domestic factors affecting their earnings, such as lower LNG imports and higher gas procurement costs.
- Watch next: natgas (up) — already moved; Historical analogues show a +20d median return of 15.03%
- Source: ADNOC Orders $900 Million in New LNG Carriers to Expand Global Fleet — OilPrice, 2026-07-10. https://oilprice.com/Latest-Energy-News/World-News/ADNOC-Orders-900-Million-in-New-LNG-Carriers-to-Expand-Global-Fleet.html
...
- vix [INDICES]: last 15.04, z20 -1.56, 1d -5.05%, |z20|=1.56
- dow_jones [INDICES]: last 52640.31, z20 1.01, 1d 0.29%, 1y-pct=98
- dyn_ms [EQUITIES]: last 222.28, z20 0.76, 1d 0.07%, 1y-pct=98
...
- midcap_largecap_ratio [DERIVED]: last 2.60, z20 1.64, 1d 0.25%, 52-wk extreme (pct=97); |z20|=1.64; 1y-pct=97
...
- dyn_qessf [EQUITIES]: last 0.25, z20 -2.09, 1d -6.45%, |z20|=2.09
- **Mechanism**: The decline in dyn_qessf may propagate through the defence sector, as Sebi's approval of Tonbo Imaging's IPO and Apollo Micro Systems' acquisition of Premier Explosives could lead to increased interest and investment in defence-related stocks. This could create a ripple effect, impacting other defence-related companies. The primary market pipeline strengthening could also boost investor confidence in the sector.
- **Gap**: No gap: the event is already reflected in the price of dyn_qessf, which has fallen by 6.45% on the day
- **India take**: The Indian instrument that expresses this move is the BSE Defence Index, which may react positively to the increased interest in the defence sector. However, it has not reacted yet, and investors should watch for potential upside in defence-related stocks such as Apollo Micro Systems and Bharat Electronics.
- Watch next: Apollo Micro Systems (up) — not yet - watch; recent acquisition announcement
- Source: Sebi approves IPOs of defence electronics maker Tonbo Imaging and 3 others — ET Markets, 2026-07-10. https://economictimes.indiatimes.com/markets/ipos/fpos/sebi-approves-ipos-of-defence-electronics-maker-tonbo-imaging-and-3-others/articleshow/132312361.cms
- Source: Multibagger defence stock Apollo Micro Systems to be in focus on Friday; here's why — Mint Markets, 2026-07-09. https://www.livemint.com/market/multibagger-defence-stock-apollo-micro-systems-to-be-in-focus-on-friday-heres-why-11783610760155.html
- Historical analogues: 2026-05-22 (d=0.0), 2025-10-15 (d=0.32), 2024-11-14 (d=0.52)

## Watchlist (below surfacing floor)
dyn_swiggy_ns ↑ (4.06), bovespa ↑ (3.9), gold_silver_ratio ↑ (3.81), dyn_cupid_ns ↑ (3.67), sofr ↓ (3.64), dyn_adanient_bo ↑ (3.25), cross-asset · 2 series ↑ (2.82), brent_wti_spread ↑ (2.3), usd_jpy ↑ (2.24), dyn_atherenerg_ns ↑ (1.89), dyn_inoxindia_ns ↑ (1.23), usd_cny ↓ (1.06)
...
- Next India prints: India CPI T-2d · NSDL FPI flows T-2d · IMD weekly rainfall T-2d · India WPI T-3d
