# Transmission Layer — board brief · 2026-07-13 23:30Z

data as of **2026-07-13** · 92 series · 11 red / 29 amber · 8 events surfaced (24 suppressed)
...
### [RED 7.76] commodities · 2 series ↑
- brent [COMMODITIES]: last 84.06, z20 1.93, zc -0.14, resid-z 0.01 [quiet], 1d 10.59%, 1-session move +10.59% ≥ 1.5%; |z20|=1.93
- wti [COMMODITIES]: last 78.93, z20 1.42, zc -0.36, resid-z -0.13 [quiet], 1d 10.53%, 1-session move +10.53% ≥ 1.5%
- **Mechanism**: The recent surge in oil prices, led by Brent and WTI, is largely priced in, with small resid_z values indicating that the move is explained by factor exposures. The commodities channel is driving the move, with correlated instruments such as CAC 40, STOXX 50, and DOW JONES not yet reacting. However, the INR_OIL_CHANNEL is weak, suggesting that the usual transmission mechanism to Indian markets may not be effective.
- **Gap**: No gap: the move in oil prices is largely explained by factor exposures, with small resid_z values
- **India take**: The Indian instrument NIFTY MIDCAP 100 has already reacted to the move in WTI, but the weak INR_OIL_CHANNEL suggests that the transmission to other Indian markets may be limited. Indian metal equities may be affected through the VALID metal_copper_channel.
...
### [RED 5.16] natgas ↓
- natgas [COMMODITIES]: last 2.90, z20 -3.16, zc -0.57, resid-z -0.91 [quiet], 1d -1.46%, |z20|=3.16
- **Mechanism**: The recent decline in natgas prices may be driven by changes in global energy dynamics, including OPEC's reduced demand forecast and the UAE's increasing presence in the US LNG market. This shift could lead to decreased prices, which may then propagate through the metal_copper_channel, given copper's historical correlation with global economic trends. However, the current move in natgas is relatively small and priced, with a resid_z of -0.91, suggesting that the decline is largely explained by factor exposures.
- **Gap**: No gap: the current decline in natgas prices is relatively small and largely explained by factor exposures, with a resid_z of -0.91, indicating no significant unexplained component.
- **India take**: Indian metal equities, such as those in the Nifty Metal index, may react to the decline in natgas prices through the metal_copper_channel. However, the reaction may be limited due to the priced nature of the move.
- Watch next: nifty_50 (down) — not yet - watch; Risk-off sentiment may lead to decreased equity prices
...
midcap_largecap_ratio ↑ (4.59), dyn_meta ↑ (4.37), gold_silver_ratio ↑ (4.0), cross-asset · 2 series ↑ (3.63), dyn_cupid_ns ↑ (3.21), shanghai_comp ↓ (3.12), cross-asset · 2 series ↓ (3.07), brent_wti_spread ↑ (2.94), cross-asset · 2 series ↑ (2.86), sofr ↓ (2.19), nifty_it ↑ (2.13), bovespa ↑ (1.92)
...
- INOXINDIA.NS (INOX INDIA LIMITED) score 34.5 — "Broker’s call: Indian Bank (Buy)"
- COIN (Coinbase Global, Inc.) score 28.4 — "Global Emissions Hit Another Record High Despite Clean Energy Boom"
- HDB (HDFC Bank Limited) score 24.8 — "Broker’s call: Indian Bank (Buy)"
- INDUSINDBK.BO (INDUSIND BANK LTD.) score 23.7 — "Broker’s call: Indian Bank (Buy)"
- INDIANB.NS (INDIAN BANK) score 19.5 — "Broker’s call: Indian Bank (Buy)"
- ATHERENERG.NS (ATHER ENERGY LIMITED) score 13.1 — "Global Emissions Hit Another Record High Despite Clean Energy Boom"
- SKHYV (SK hynix Inc. American Deposit) score 12.6 — "SK HYNIX VOLATILITY GOES BOTH WAYS SK Hynix plunged a record 15%, dragging the Kospi down "
...
- PCJEWELLER.NS (PC JEWELLER LTD) score 7.8 — "Q1 surprise sends jewellery stocks shining 40% in a month. Will the surge last in next qua"
- BOND (PIMCO Active Bond Exchange-Tra) score 7.5 — "India bonds fall as oil spike, Treasury rout weigh"
- VT (Vanguard Total World Stock Ind) score 5.9 — "Masdar Secures $5.1 Billion for World’s Largest Solar-and-Battery Project"
...
- QESSF (AEGIS CRITICAL ENERGY DEFENCE ) score 5.2 — "FRANCE'S MACRON: UKRAINE HAS AGREED TO BUY SAMP-T AIR DEFENCE SYSTEM"
- META (Meta) score 4.4 — "Meta and Amazon are leading a trillion-dollar Big Tech spending spree"
- MU (Micron Technology, Inc.) score 4.0 — "Micron and other chip stocks feel the pain of imported volatility — blame SK Hynix"
...
- BHARTIARTL.NS (BHARTI AIRTEL LIMITED) score 3.2 — "Mcap of 4 of top-10 most valued firms jumps ₹92,995 crore; HDFC Bank, Airtel top gainers"
