# Transmission Layer — board brief · 2026-09-11 19:09Z

data as of **2026-09-11** · 98 series · 8 red / 39 amber · 8 events surfaced (30 suppressed)

## Regime & assumption health (measured at generation)
- **Regime: NEUTRAL** (score 0.579, 1d in regime; vol-pct 0.452, breadth-off 0.706, Markov P(high-vol) 0.025)
...
- [WEAK] **metal_copper_channel** — corr20 0.03, corr60 0.28, last shift 2026-07-08. Channel: global copper leads Indian metal equities
...
- [WEAK] **dxy_inr_channel** — corr20 -0.11, corr60 -0.02, last shift 2026-01-22. Channel: broad dollar strength -> EM FX weakness incl INR
- [WEAK] **real_rates_gold_inverse** — corr20 -0.29, corr60 -0.17, last shift 2026-06-30. Channel: real yields up -> non-yielding gold down
- [WEAK] **gsr_stress_gauge** — corr20 0.17, corr60 0.11, last shift 2026-07-24. Channel: gold/silver ratio rises under monetary stress

## Scan control & verified transmission setups
- FDR (BH q=0.1): **0 of 90** scanned series survive multiplicity control (effective p ≤ None)
- **SETUP** dyn_dell → taiwan_weighted: leads 1d (ccf 0.368, β 0.1478, p 1e-05); driver zc 1.94 → expected 1.508%. Type hit-rate 0.82 (n=2041).
- **SETUP** dyn_hdb → usd_inr: leads 1d (ccf -0.348, β -0.0875, p 0.0); driver zc 4.33 → expected -0.541%. Type hit-rate 0.82 (n=2041).
- **SETUP** dyn_qcom → aud_usd: leads 1d (ccf 0.336, β 0.071, p 0.0); driver zc 1.74 → expected 0.246%. Type hit-rate 0.82 (n=2041).
...
### [RED 8.21] commodities · 2 series ↑
- wti [COMMODITIES]: last 100.47, z20 2.38, zc -0.60, resid-z -0.28 [quiet], 1d -1.96%, 1-session move -1.96% ≥ 1.5%; |z20|=2.38
- brent [COMMODITIES]: last 104.94, z20 2.36, zc -0.73, resid-z -0.47 [quiet], 1d -2.50%, 1-session move -2.50% ≥ 1.5%; |z20|=2.36
- **Mechanism**: commodities · 2 series ↑: correlated cluster flagged by the engine. Mechanism narrative unassessed (LLM off). Nearest historical analogue: 2026-05-22 (z-distance 0.0).
- **Gap**: Unassessed (LLM off) — laggard list above is the live math.
- **India take**: No exposed Indian receivers above the correlation floor.
- Watch next: comex_copper (inverse) — not yet - watch; rho -0.503 vs wti, historically leads by 1d
- Watch next: sp500 (inverse) — not yet - watch; rho -0.624 vs wti
- Watch next: dyn_vt (inverse) — not yet - watch; rho -0.565 vs wti
- Watch next: vix (co-move) — not yet - watch; rho 0.516 vs wti
...
### [RED 6.91] cross-asset · 5 series ↑
- dyn_bond [EQUITIES]: last 88.81, z20 -2.98, zc -0.43, resid-z -1.11 [quiet], 1d -0.15%, |z20|=2.98; 1y-pct=0
...
- **Gap**: Unassessed (LLM off) — laggard list above is the live math.
- **India take**: No exposed Indian receivers above the correlation floor.
- Watch next: dyn_vt (co-move) — not yet - watch; rho 0.511 vs dyn_bond, historically leads by 3d
- Watch next: dxy (inverse) — not yet - watch; rho -0.532 vs dyn_bond
- Watch next: eur_usd (co-move) — not yet - watch; rho 0.32 vs ust_2y, historically leads by 1d
...
- nifty_midcap_100 [INDICES]: last 62199.10, z20 -2.39, zc -0.39, resid-z -0.42 [quiet], 1d -0.26%, |z20|=2.39
- nifty_50 [INDICES]: last 23398.10, z20 -2.37, zc -0.61, resid-z -0.76 [quiet], 1d -0.34%, |z20|=2.37
...
- nikkei_225 [INDICES]: last 64006.42, z20 -1.69, zc -1.45, resid-z -1.17 [quiet], 1d -1.94%, |z20|=1.69
- shanghai_comp [INDICES]: last 3886.80, z20 -1.58, zc -1.72, resid-z -1.20 [moved], 1d -1.21%, |z20|=1.58
...
### [AMBER 4.18] dyn_meta ↑
- dyn_meta [EQUITIES]: last 650.30, z20 2.18, zc 0.35, resid-z 2.62 [unexplained], 1d 0.92%, |z20|=2.18
...
- **Gap**: Unassessed (LLM off) — laggard list above is the live math.
- **India take**: nifty_midcap_100 (rho 0.367 via dyn_meta, z -2.39, reacted)
- **India receivers**: nifty_midcap_100 (rho 0.367, z -2.39)
...
- dyn_tatatech_ns [EQUITIES]: last 765.60, z20 -2.15, zc -0.81, resid-z -0.58 [quiet], 1d -1.73%, |z20|=2.15
...
- dyn_indianb_ns [EQUITIES]: last 853.50, z20 -2.13, zc -0.18, resid-z -0.22 [quiet], 1d -0.35%, |z20|=2.13
...
usd_jpy ↓ (4.01), dyn_icicigi_bo ↓ (3.99), gold_silver_ratio ↑ (3.87), dyn_pcjeweller_ns ↑ (3.78), asx_200 ↓ (3.73), indices · 4 series ↓ (3.7), dyn_qcom ↑ (3.22), cross-asset · 2 series ↓ (3.14), dyn_atherenerg_ns ↑ (3.08), hang_seng ↓ (2.89), usd_cny ↓ (2.7), dyn_dell ↑ (2.44)
...
- INOXINDIA.NS (INOX INDIA LIMITED) score 89.6 — "Granules India promoter sells 1.72 crore shares worth Rs 1,500 crore; Goldman Sachs, BNP P"
- COALINDIA.NS (COAL INDIA LTD) score 86.5 — "Granules India promoter sells 1.72 crore shares worth Rs 1,500 crore; Goldman Sachs, BNP P"
- HAVELLS.NS (HAVELLS INDIA LIMITED) score 85.9 — "Granules India promoter sells 1.72 crore shares worth Rs 1,500 crore; Goldman Sachs, BNP P"
- INDIANB.NS (INDIAN BANK) score 65.5 — "FRANCE DEBT CANCELLATION PLAN SLAMMED AS “DANGEROUS” Bank of France chief Emmanuel Moulin "
- BAC (Bank of America Corporation) score 62.2 — "TRUMP SUGGESTS ELECTION MAY LIMIT IRAN ESCALATION President Donald Trump said the upcoming"
- COIN (Coinbase Global, Inc.) score 60.6 — "APPLE’S $1,999 FOLDABLE FACES DEMAND TEST Apple’s new iPhone Duo starts at $1,999, but ana"
- HDB (HDFC Bank Limited) score 53.0 — "FRANCE DEBT CANCELLATION PLAN SLAMMED AS “DANGEROUS” Bank of France chief Emmanuel Moulin "
- OHI (Omega Healthcare Investors, In) score 51.0 — "Granules India promoter sells 1.72 crore shares worth Rs 1,500 crore; Goldman Sachs, BNP P"
- IDBI.NS (IDBI BANK LIMITED) score 49.2 — "FRANCE DEBT CANCELLATION PLAN SLAMMED AS “DANGEROUS” Bank of France chief Emmanuel Moulin "
- INDUSINDBK.BO (INDUSIND BANK LTD.) score 49.2 — "FRANCE DEBT CANCELLATION PLAN SLAMMED AS “DANGEROUS” Bank of France chief Emmanuel Moulin "
- KARURVYSYA.NS (KARUR VYSYA BANK LTD) score 49.2 — "FRANCE DEBT CANCELLATION PLAN SLAMMED AS “DANGEROUS” Bank of France chief Emmanuel Moulin "
- BOND (PIMCO Active Bond Exchange-Tra) score 44.8 — "S&P 500’S 8,000 MILESTONE REMAINS ELUSIVE The S&P 500 is still 5.4% away from 8,000, as ri"
- CHKP (Check Point Software Technolog) score 43.8 — "Your Social Security check could go up another $71 next year. That’s not necessarily good "
- TECHM.NS (TECH MAHINDRA LIMITED) score 36.5 — "TRUMP DISMISSES AI EXTINCTION FEARS President Donald Trump says he has “no” concerns that "
- CARTRADE.NS (CARTRADE TECH LIMITED) score 36.4 — "TRUMP DISMISSES AI EXTINCTION FEARS President Donald Trump says he has “no” concerns that "
- TECH (Bio-Techne Corp) score 36.4 — "TRUMP DISMISSES AI EXTINCTION FEARS President Donald Trump says he has “no” concerns that "
- LTH (Life Time Group Holdings, Inc.) score 36.4 — "Dow Jones| Nasdaq | S&P 500 | US Stock Market Today |Live Updates: US stocks climb as infl"
- 301077.SZ (CHINASTARS) score 29.9 — "TRUMP DISMISSES AI EXTINCTION FEARS President Donald Trump says he has “no” concerns that "
- ATHERENERG.NS (ATHER ENERGY LIMITED) score 23.6 — "GULF STATES WEIGH TALKS WITH IRAN OVER HORMUZ Gulf states are considering rare talks with "
- SEPN (Septerna, Inc.) score 17.2 — "UMICH PRELIM. SEPT. CONSUMER SENTIMENT FALLS TO 47.8; EST. 51"
- JIOFIN.BO (Jio Financial Services Limited) score 13.0 — "US CORE INFLATION UPSIDE DRIVEN BY SUPERCORE The latest inflation details show the upside "
- JUSTDIAL.BO (JUST DIAL LTD.) score 13.0 — "Molbio Diagnostics shares surge over 50% in just 3 days! What is driving the rally?"
- ADANIENT.BO (ADANI ENTERPRISES LTD.) score 12.7 — "Adani Ports SEZ Share Price Live Updates: Adani Ports SEZ Current Price Update"
- STYLEBAAZA.NS (BAAZAR STYLE RETAIL LTD) score 11.7 — "US AVERAGE RETAIL DIESEL PRICE RISES PAST $6 A GALLON: AAA"
- MS (Morgan Stanley) score 10.4 — "MUNI YIELDS SURGE TO HIGHEST SINCE APRIL 2025 U.S. 10-year municipal bond yields jumped to"
- PCJEWELLER.NS (PC JEWELLER LTD) score 10.3 — "Dividend stocks alert! Last chance to qualify- Kalyan Jewellers, Aarti Industries, Blue Je"
- TATAELXSI.NS (TATA ELXSI LIMITED) score 8.7 — "Tata Steel share price falls 3%, among top Nifty 50 laggards; what experts say"
- TATATECH.NS (TATA TECHNOLOGIES LIMITED) score 8.7 — "Tata Steel share price falls 3%, among top Nifty 50 laggards; what experts say"
- META (Meta) score 8.5 — "Vedanta Aluminium Metal shares dip over 3% | Here's why Anil Agarwal-owned stock is nosedi"
- 4417.T (GLOBAL SECURITY EXPERTS INC) score 7.3 — "Cochin Shipyard shares crash nearly 9% - Is it opportunity to buy? Should you take fresh e"
- MUTHOOTFIN.NS (MUTHOOT FINANCE LIMITED) score 6.8 — "Joint finances, joint risks: A couple’s roadmap to starting up"
- VT (Vanguard Total World Stock Ind) score 6.7 — "Smartworld Developers raises Rs 800 cr from Kotak Realty Fund for two projects in Gurugram"
- ICICIGI.BO (ICICI Lombard General Insuranc) score 6.7 — "ICICI Bank Share Price Live Updates: Rs 1.09 crore remittance sent home by an Indian worki"
- JEF (Jefferies Financial Group Inc.) score 6.5 — "Jefferies cuts KEI Industries target price by 11%. Will UltraTech’s entry put the company "
- NVDA (NVIDIA Corporation) score 6.3 — "NVDA - NVIDIA’S HUANG SEES CYBERSECURITY AS AI’S NEXT BIG MARKET Nvidia CEO Jensen Huang s"
