# Transmission Layer — board brief · 2026-08-19 14:51Z

data as of **2026-08-19** · 98 series · 13 red / 32 amber · 8 events surfaced (29 suppressed)

## Regime & assumption health (measured at generation)
- **Regime: RISK_ON** (score 0.293, 3d in regime; vol-pct 0.233, breadth-off 0.353, Markov P(high-vol) 0.015)
...
- FDR (BH q=0.1): **2 of 89** scanned series survive multiplicity control (effective p ≤ 0.0005401753879268334)
- **SETUP** dxy → aud_usd: leads 1d (ccf -0.573, β -0.8513, p 0.0); driver zc -2.7 → expected 0.73%. Type hit-rate 0.829 (n=2338).
- **SETUP** bovespa → usd_brl: leads 1d (ccf -0.57, β -0.4374, p 0.0); driver zc 2.06 → expected -0.972%. Type hit-rate 0.829 (n=2338).
- **SETUP** bovespa → aud_usd: leads 1d (ccf 0.392, β 0.2327, p 0.0); driver zc 2.06 → expected 0.517%. Type hit-rate 0.829 (n=2338).
- **SETUP** dyn_coin → asx_200: leads 1d (ccf 0.316, β 0.0491, p 0.0); driver zc 1.9 → expected 0.425%. Type hit-rate 0.829 (n=2338).
- Track record · residual_reversion: hit-rate **0.496** (n=1115) — |resid_z|>=2.0 -> fwd 5d return opposes residual
- Track record · transmission_follow: hit-rate **0.829** (n=2338) — first-half-significant lead pairs; driver |zc|>=1.5 on 2nd half -> target next-k cum ret matches beta-implied sign
- Track record · spread_reversion: hit-rate **0.533** (n=15) — |dev| >= 2sigma vs PIT 252d -> |dev| shrinks >=25% within max(half-life,10) sessions

## Events (ranked)

### [RED 27.78] dyn_mrna ↑
- dyn_mrna [EQUITIES]: last 148.75, z20 25.78, zc 33.58, resid-z 0.65 [moved], 1d 136.26%, |z20|=25.78; 1y-pct=100
...
- Source: Moderna shares climb over 110% as mRNA vaccine with Merck succeeds in large trial for skin cancer — Mint Markets, 2026-08-19. https://www.livemint.com/market/stock-market-news/moderna-shares-climb-nearly-100-as-mrna-vaccine-with-merck-succeeds-in-large-trial-for-skin-cancer-11787143887774.html
- Historical analogues: 2026-05-22 (d=0.0), 2025-05-16 (d=0.01), 2025-08-20 (d=0.01)

### [AMBER 6.09] fx · 4 series ↑
- eur_usd [FX]: last 1.17, z20 2.43, zc 2.22, resid-z 1.57 [unexplained], 1d 0.73%, |z20|=2.43
- aud_usd [FX]: last 0.71, z20 2.25, zc 0.40, resid-z 0.63 [quiet], 1d 0.20%, |z20|=2.25
- gbp_usd [FX]: last 1.36, z20 2.17, zc 1.06, resid-z 0.69 [quiet], 1d 0.45%, |z20|=2.17
- usd_mxn [FX]: last 16.96, z20 -1.89, zc -1.21, resid-z -1.04 [quiet], 1d -0.43%, |z20|=1.89; 1y-pct=0
...
- **Gap**: Unassessed (LLM off) — laggard list above is the live math.
- **India take**: dyn_muthootfin_ns (rho -0.53 via usd_mxn, z -1.13, reacted); dyn_icicigi_bo (rho -0.427 via gbp_usd, z -1.09, reacted); nifty_midcap_100 (rho 0.393 via aud_usd, z 0.33, quiet)
- Watch next: usd_brl (inverse) — not yet - watch; rho -0.59 vs eur_usd, historically leads by 4d
...
- **India receivers**: dyn_muthootfin_ns (rho -0.53, z -1.13); dyn_icicigi_bo (rho -0.427, z -1.09); nifty_midcap_100 (rho 0.393, z 0.33)
...
### [RED 5.72] commodities · 3 series ↑
- corn [COMMODITIES]: last 495.00, z20 4.40, zc 5.36, resid-z 4.04 [unexplained], 1d 6.85%, |z20|=4.40; 1y-pct=100
- wheat [COMMODITIES]: last 697.25, z20 1.96, zc 2.76, resid-z 1.68 [unexplained], 1d 4.93%, |z20|=1.96; 1y-pct=99
- soybeans [COMMODITIES]: last 1234.25, z20 1.70, zc 2.76, resid-z 2.29 [unexplained], 1d 2.79%, |z20|=1.70; 1y-pct=99
...
### [RED 5.54] crypto · 2 series ↑
- btc_usd [CRYPTO]: last 65567.05, z20 2.71, zc 0.77, resid-z -0.02 [quiet], 1d 1.37%, |z20|=2.71
- eth_usd [CRYPTO]: last 1945.21, z20 2.54, zc 0.40, resid-z -0.29 [quiet], 1d 1.50%, |z20|=2.54
- **Mechanism**: crypto · 2 series ↑: correlated cluster flagged by the engine. Mechanism narrative unassessed (LLM off). Nearest historical analogue: 2026-01-13 (z-distance 0.05).
- **Gap**: Unassessed (LLM off) — laggard list above is the live math.
- **India take**: No exposed Indian receivers above the correlation floor.
- Watch next: dyn_coin (co-move) — not yet - watch; rho 0.844 vs btc_usd, historically leads by 5d
- Watch next: dyn_nvda (co-move) — not yet - watch; rho 0.564 vs eth_usd, historically leads by 3d
- Watch next: vix (inverse) — not yet - watch; rho -0.672 vs eth_usd
- Watch next: dyn_vt (co-move) — not yet - watch; rho 0.564 vs btc_usd
- Watch next: dyn_ms (co-move) — not yet - watch; rho 0.55 vs btc_usd
...
- Historical analogues: 2026-01-13 (d=0.05), 2025-07-09 (d=0.13), 2026-03-04 (d=0.31)

### [RED 5.34] dyn_voltas_ns ↓
- dyn_voltas_ns [EQUITIES]: last 1223.00, z20 -3.34, zc -1.24, resid-z -1.10 [quiet], 1d -2.39%, |z20|=3.34; 1y-pct=0
...
### [RED 5.1] dxy ↓
- dxy [FX]: last 98.79, z20 -2.10, zc -2.70, resid-z -0.61 [moved], 1d -0.86%, 20d range extreme; |z20|=2.10
...
midcap_largecap_ratio ↑ (4.92), cross-asset · 4 series ↑ (4.69), dyn_stylebaaza_ns ↑ (4.65), dyn_bharatcoal_ns ↓ (4.35), comex_gold ↑ (4.26), dyn_coalindia_ns ↓ (4.25), dyn_tech ↑ (4.12), dyn_meta ↓ (3.86), usd_cny ↓ (3.46), gold_silver_ratio ↑ (3.38), dyn_icicigi_bo ↓ (3.09), nifty_fmcg ↓ (2.97)
...
- COALINDIA.NS (COAL INDIA LTD) score 101.3 — "Ceigall India secures another road project in Arunachal Pradesh worth  ₹274 crore"
- INOXINDIA.NS (INOX INDIA LIMITED) score 100.9 — "Ceigall India secures another road project in Arunachal Pradesh worth  ₹274 crore"
- HAVELLS.NS (HAVELLS INDIA LIMITED) score 100.1 — "Ceigall India secures another road project in Arunachal Pradesh worth  ₹274 crore"
- INDIANB.NS (INDIAN BANK) score 84.0 — "Indian stocks least preferred for Asia fund managers: BofA survey"
- BAC (Bank of America Corporation) score 66.7 — "POLL SHOWS 69% SEE TRUMP BUSINESS INFLUENCE A Reuters/Ipsos poll found 69% of Americans be"
- HDB (HDFC Bank Limited) score 59.2 — "Nifty fall for seventh straight session; banks, metals drag as crude weighs on sentiment"
- IDBI.NS (IDBI BANK LIMITED) score 54.7 — "Nifty fall for seventh straight session; banks, metals drag as crude weighs on sentiment"
- INDUSINDBK.BO (INDUSIND BANK LTD.) score 54.7 — "Nifty fall for seventh straight session; banks, metals drag as crude weighs on sentiment"
- KARURVYSYA.NS (KARUR VYSYA BANK LTD) score 54.7 — "Nifty fall for seventh straight session; banks, metals drag as crude weighs on sentiment"
- COIN (Coinbase Global, Inc.) score 53.7 — "BlackRock, Capital Group anchor IDFC FIRST Bank’s maiden $500 million global bond"
- TECHM.NS (TECH MAHINDRA LIMITED) score 52.8 — "Dow Jones| Nasdaq | US Stock Market Today | Live: US stocks edge higher as yields ease aft"
- CARTRADE.NS (CARTRADE TECH LIMITED) score 51.0 — "Dow Jones| Nasdaq | US Stock Market Today | Live: US stocks edge higher as yields ease aft"
- TECH (Bio-Techne Corp) score 50.8 — "Dow Jones| Nasdaq | US Stock Market Today | Live: US stocks edge higher as yields ease aft"
- BOND (PIMCO Active Bond Exchange-Tra) score 50.4 — "Foreign capital, corporate bond market key priorities for DEA: Alok Tiwari"
- OHI (Omega Healthcare Investors, In) score 43.1 — "The bond selloff is rattling investors, but here’s why they shouldn’t expect a deeper stoc"
- CHKP (Check Point Software Technolog) score 35.2 — "Mopshop Distribution IPO Day 1: Issue booked 29% so far. Check GMP, issue details"
- LTH (Life Time Group Holdings, Inc.) score 34.3 — "Ukraine’s Ousted Defense Chief Calls for Wartime Elections"
- JIOFIN.BO (Jio Financial Services Limited) score 20.6 — "IRAN REPORTEDLY WEIGHS STRIKES ON U.S. TARGETS IN EUROPE Iran is considering expanding its"
- 301077.SZ (CHINASTARS) score 19.9 — "China’s Solar Exports Fell 21.4% in July"
- ATHERENERG.NS (ATHER ENERGY LIMITED) score 19.8 — "Iran War Set to Drive UK Energy Bills to 3-Year High"
- TATAELXSI.NS (TATA ELXSI LIMITED) score 19.1 — "Top Gainers & Losers on 19 Aug: Netweb Tech, Bata, Reliance Power, Bharat Dynamics, Tata C"
- TATATECH.NS (TATA TECHNOLOGIES LIMITED) score 17.8 — "Top Gainers & Losers on 19 Aug: Netweb Tech, Bata, Reliance Power, Bharat Dynamics, Tata C"
- PCJEWELLER.NS (PC JEWELLER LTD) score 16.8 — "Lalithaa Jewellery IPO Day 3: Issue booked 63x, QIB category leads at 145x"
- BHARATCOAL.NS (BHARAT COKING COAL LTD) score 15.1 — "Indian steel mills face margin squeeze as global coking coal prices rise"
- HDBFS.BO (HDB FINANCIAL SERVICES LIMITED) score 14.0 — "IRAN REPORTEDLY WEIGHS STRIKES ON U.S. TARGETS IN EUROPE Iran is considering expanding its"
- MUTHOOTFIN.NS (MUTHOOT FINANCE LIMITED) score 11.8 — "Market wrap:  HCL Tech, Sun Pharma, Power Grid, Bajaj Finance top gainers and losers on Ni"
- MS (Morgan Stanley) score 10.3 — "ANTHROPIC LINES UP $10B+ CREDIT AHEAD OF IPO Anthropic’s revolving credit facility is set "
- JUSTDIAL.BO (JUST DIAL LTD.) score 9.9 — "Ashok Leyland just had a record June quarter. So why did the margin fall a full point?"
- META (Meta) score 9.3 — "Metal stock to be in focus on Thursday after this Capex expansion update. Details here"
- VT (Vanguard Total World Stock Ind) score 8.1 — "India's gold demand recovery likely to strengthen ahead of festive season: World Gold Coun"
- STYLEBAAZA.NS (BAAZAR STYLE RETAIL LTD) score 8.1 — "Dow Jones| Nasdaq | US Stock Market Today | Live: US futures steady after tech rout; Iran "
- ADANIENT.BO (ADANI ENTERPRISES LTD.) score 8.0 — "IGL, MGL to Adani Total Gas: City gas distributor stocks rise up to 4%; here's why"
- BHARATFORG.BO (BHARAT FORGE LTD.) score 7.6 — "Top Gainers & Losers on 19 Aug: Netweb Tech, Bata, Reliance Power, Bharat Dynamics, Tata C"
- NVDA (NVIDIA Corporation) score 7.1 — "NVDA - BOFA: NVIDIA COULD BE UP TO 50% UNDERVALUED Bank of America says Nvidia may trade a"
- ICICIGI.BO (ICICI Lombard General Insuranc) score 6.7 — "ICICI Bank shares slip 0.52% in early trade, despite yearly gains"
...
- MRNA (Moderna, Inc.) score 4.0 — "Moderna shares climb over 110% as mRNA vaccine with Merck succeeds in large trial for skin"
