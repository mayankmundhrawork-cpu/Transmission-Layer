# Transmission Layer — board brief · 2026-08-20 21:51Z
...
- **SETUP** dow_jones → asx_200: leads 1d (ccf 0.593, β 0.4879, p 0.0); driver zc -1.88 → expected -0.629%. Type hit-rate 0.827 (n=2456).
- **SETUP** dyn_ms → asx_200: leads 1d (ccf 0.489, β 0.1968, p 0.0); driver zc -1.84 → expected -0.618%. Type hit-rate 0.827 (n=2456).
- **SETUP** dow_jones → nikkei_225: leads 1d (ccf 0.466, β 0.7886, p 0.0); driver zc -1.88 → expected -1.017%. Type hit-rate 0.827 (n=2456).
- **SETUP** dyn_jef → asx_200: leads 1d (ccf 0.456, β 0.1309, p 0.0); driver zc -1.64 → expected -0.425%. Type hit-rate 0.827 (n=2456).
- **SETUP** dow_jones → taiwan_weighted: leads 1d (ccf 0.424, β 0.7139, p 0.0); driver zc -1.88 → expected -0.92%. Type hit-rate 0.827 (n=2456).
- **SETUP** dyn_ms → nikkei_225: leads 1d (ccf 0.416, β 0.3455, p 0.0); driver zc -1.84 → expected -1.086%. Type hit-rate 0.827 (n=2456).
- **SETUP** dow_jones → usd_brl: leads 1d (ccf -0.407, β -0.3513, p 0.0); driver zc -1.88 → expected 0.453%. Type hit-rate 0.827 (n=2456).
- **SETUP** dow_jones → aud_usd: leads 1d (ccf 0.399, β 0.2623, p 1e-05); driver zc -1.88 → expected -0.338%. Type hit-rate 0.827 (n=2456).
- **SETUP** dyn_ms → taiwan_weighted: leads 1d (ccf 0.394, β 0.3251, p 0.0); driver zc -1.84 → expected -1.021%. Type hit-rate 0.827 (n=2456).
- **SETUP** dow_jones → usd_mxn: leads 1d (ccf -0.362, β -0.2377, p 0.0); driver zc -1.88 → expected 0.306%. Type hit-rate 0.827 (n=2456).
- **SETUP** dyn_ms → aud_usd: leads 1d (ccf 0.279, β 0.0896, p 0.00264); driver zc -1.84 → expected -0.281%. Type hit-rate 0.827 (n=2456).
- **SETUP** dyn_jef → usd_mxn: leads 1d (ccf -0.259, β -0.0597, p 0.00023); driver zc -1.64 → expected 0.194%. Type hit-rate 0.827 (n=2456).
- Track record · residual_reversion: hit-rate **0.491** (n=1116) — |resid_z|>=2.0 -> fwd 5d return opposes residual
- Track record · transmission_follow: hit-rate **0.827** (n=2456) — first-half-significant lead pairs; driver |zc|>=1.5 on 2nd half -> target next-k cum ret matches beta-implied sign
...
### [RED 9.77] cross-asset · 3 series ↑
- btc_usd [CRYPTO]: last 72707.64, z20 6.46, zc 1.50, resid-z 2.75 [unexplained], 1d 4.97%, |z20|=6.46
- eth_usd [CRYPTO]: last 2318.67, z20 5.02, zc 0.49, resid-z 1.33 [quiet], 1d 2.99%, |z20|=5.02
- dyn_coin [EQUITIES]: last 172.46, z20 2.62, zc 1.52, resid-z 2.13 [unexplained], 1d 7.65%, |z20|=2.62
- **Mechanism**: cross-asset · 3 series ↑: correlated cluster flagged by the engine. Mechanism narrative unassessed (LLM off). Nearest historical analogue: 2025-08-13 (z-distance 2.04).
- **Gap**: Unassessed (LLM off) — laggard list above is the live math.
- **India take**: No exposed Indian receivers above the correlation floor.
- Watch next: vix (inverse) — not yet - watch; rho -0.572 vs eth_usd
...
- Historical analogues: 2025-08-13 (d=2.04), 2025-05-08 (d=2.93), 2024-11-13 (d=3.17)

### [RED 7.63] cross-asset · 3 series ↑
- comex_gold [COMMODITIES]: last 4575.10, z20 2.17, zc 1.11, resid-z 0.72 [quiet], 1d 1.91%, |z20|=2.17; co-occur[gold_silver] same-direction (channel VALID)
- comex_silver [COMMODITIES]: last 68.13, z20 2.00, zc 1.48, resid-z 0.70 [quiet], 1d 3.64%, |z20|=2.00; co-occur[gold_silver] same-direction (channel VALID)
- gold_silver_ratio [DERIVED]: last 67.15, z20 -1.31, zc n/a, resid-z n/a [quiet], 1d -1.67%, GSR<75 (extreme low)
...
### [RED 6.19] fx · 4 series ↑
- eur_usd [FX]: last 1.17, z20 2.52, zc 2.73, resid-z 2.73 [unexplained], 1d 0.88%, |z20|=2.52
- gbp_usd [FX]: last 1.36, z20 2.29, zc 1.69, resid-z 1.65 [unexplained], 1d 0.70%, |z20|=2.29
- aud_usd [FX]: last 0.71, z20 1.84, zc 0.82, resid-z 0.89 [quiet], 1d 0.42%, |z20|=1.84
- usd_mxn [FX]: last 16.94, z20 -1.83, zc -1.93, resid-z -1.46 [moved], 1d -0.67%, |z20|=1.83; 1y-pct=0
...
- **Gap**: Unassessed (LLM off) — laggard list above is the live math.
- **India take**: dyn_muthootfin_ns (rho -0.588 via usd_mxn, z 0.49, quiet); nifty_midcap_100 (rho 0.411 via aud_usd, z 0.63, quiet); dyn_icicigi_bo (rho -0.392 via gbp_usd, z -0.67, quiet)
...
- Watch next: usd_jpy (inverse) — not yet - watch; rho -0.519 vs eur_usd
- **India receivers**: dyn_muthootfin_ns (rho -0.588, z 0.49); nifty_midcap_100 (rho 0.411, z 0.63); dyn_icicigi_bo (rho -0.392, z -0.67)
...
- wheat [COMMODITIES]: last 699.50, z20 2.43, zc 1.55, resid-z 1.28 [moved], 1d 2.83%, |z20|=2.43; 1y-pct=99
- soybeans [COMMODITIES]: last 1236.00, z20 1.82, zc 1.10, resid-z 0.82 [quiet], 1d 1.12%, |z20|=1.82; 1y-pct=99
...
### [AMBER 5.98] brent ↑
- brent [COMMODITIES]: last 93.15, z20 0.98, zc 0.77, resid-z 0.12 [quiet], 1d 1.67%, 1-session move +1.67% ≥ 1.5%
...
- Watch next: dow_jones (inverse) — not yet - watch; rho -0.652 vs brent
- Watch next: ust_30y (co-move) — not yet - watch; rho 0.521 vs brent
...
- dyn_lenskart_ns [EQUITIES]: last 656.65, z20 3.15, zc 1.65, resid-z 1.60 [unexplained], 1d 2.67%, |z20|=3.15; 1y-pct=99
...
dyn_stylebaaza_ns ↑ (4.54), midcap_largecap_ratio ↑ (4.39), dyn_jef ↓ (4.21), dyn_meta ↓ (3.86), usd_cny ↓ (3.39), dyn_tech ↑ (2.92), eur_inr ↑ (2.75), indices · 2 series ↑ (2.68), dyn_voltas_ns ↓ (2.68), dyn_icicigi_bo ↓ (2.67), dyn_tatatech_ns ↑ (2.51), dyn_lth ↑ (2.44)
...
- COALINDIA.NS (COAL INDIA LTD) score 100.7 — "China Is Squeezing India Out of Russia’s Oil Trade"
- INOXINDIA.NS (INOX INDIA LIMITED) score 98.8 — "China Is Squeezing India Out of Russia’s Oil Trade"
- HAVELLS.NS (HAVELLS INDIA LIMITED) score 98.1 — "China Is Squeezing India Out of Russia’s Oil Trade"
- INDIANB.NS (INDIAN BANK) score 88.0 — "Federal Reserve Board announces approval of application by National Westminster Bank Plc"
- BOND (PIMCO Active Bond Exchange-Tra) score 77.5 — "The bond market is going to burst the stock-market bubble"
- BAC (Bank of America Corporation) score 71.8 — "Sports betting to build wealth is becoming the new American dream"
- HDB (HDFC Bank Limited) score 65.3 — "Federal Reserve Board announces approval of application by National Westminster Bank Plc"
- IDBI.NS (IDBI BANK LIMITED) score 60.2 — "Federal Reserve Board announces approval of application by National Westminster Bank Plc"
- INDUSINDBK.BO (INDUSIND BANK LTD.) score 60.2 — "Federal Reserve Board announces approval of application by National Westminster Bank Plc"
- KARURVYSYA.NS (KARUR VYSYA BANK LTD) score 60.2 — "Federal Reserve Board announces approval of application by National Westminster Bank Plc"
- COIN (Coinbase Global, Inc.) score 54.7 — "Global Market: European blue-chip earnings outlook improves as recovery broadens"
- OHI (Omega Healthcare Investors, In) score 47.3 — "Anxious bond market sends troubling message to investors: There’s no easy fix for U.S. deb"
- TECHM.NS (TECH MAHINDRA LIMITED) score 47.1 — "General Atlantic Singapore sells Rs 1,400 crore KFin Technologies stake; Invesco, Mirae As"
- CARTRADE.NS (CARTRADE TECH LIMITED) score 45.7 — "General Atlantic Singapore sells Rs 1,400 crore KFin Technologies stake; Invesco, Mirae As"
- TECH (Bio-Techne Corp) score 45.6 — "General Atlantic Singapore sells Rs 1,400 crore KFin Technologies stake; Invesco, Mirae As"
- LTH (Life Time Group Holdings, Inc.) score 38.9 — "Social Security union says it needs $3 billion and another 20,000 workers to fix long wait"
- CHKP (Check Point Software Technolog) score 34.6 — "IPOs GMP comparison: Check grey market winner - Shankesh Jewellers vs Sunshine Pictures vs"
- ATHERENERG.NS (ATHER ENERGY LIMITED) score 22.7 — "Europe’s Energy Reserves Worked. The Next Test Will Be Harder"
- JIOFIN.BO (Jio Financial Services Limited) score 21.4 — "Tourism Finance Corporation among 6 financial services stocks to hit 52-week highs & surge"
- PCJEWELLER.NS (PC JEWELLER LTD) score 21.3 — "Keralam gold jewellery trade bets big on Onam sales"
- 301077.SZ (CHINASTARS) score 21.2 — "As China shows, liberal capitalism is not the only path"
- HDBFS.BO (HDB FINANCIAL SERVICES LIMITED) score 16.6 — "Tourism Finance Corporation among 6 financial services stocks to hit 52-week highs & surge"
- BHARATCOAL.NS (BHARAT COKING COAL LTD) score 15.6 — "Coking Coal Prices Surge 25%, Squeezing India's Steelmakers"
- MUTHOOTFIN.NS (MUTHOOT FINANCE LIMITED) score 14.9 — "Tourism Finance Corporation among 6 financial services stocks to hit 52-week highs & surge"
- TATAELXSI.NS (TATA ELXSI LIMITED) score 14.1 — "Top Gainers & Losers on 19 Aug: Netweb Tech, Bata, Reliance Power, Bharat Dynamics, Tata C"
- STYLEBAAZA.NS (BAAZAR STYLE RETAIL LTD) score 14.1 — "UPI adoption accelerates in capital markets, led by brokers and rising retail participatio"
- TATATECH.NS (TATA TECHNOLOGIES LIMITED) score 13.2 — "Top Gainers & Losers on 19 Aug: Netweb Tech, Bata, Reliance Power, Bharat Dynamics, Tata C"
- MS (Morgan Stanley) score 12.0 — "Treasury’s buyback blitz may end up driving bond yields higher, warns JPMorgan. Here’s its"
- MRNA (Moderna, Inc.) score 11.0 — "Moderna’s personalized mRNA shot could reshape the fight against skin cancer — but it may "
- META (Meta) score 9.6 — "Silver futures jump nearly 1% to ₹2.38 lakh/kg as US Treasury move boosts precious metals"
- ADANIENT.BO (ADANI ENTERPRISES LTD.) score 9.5 — "Gautam Adani’s big comeback: Adani Enterprises eyes Nifty crown"
...
- ICICIGI.BO (ICICI Lombard General Insuranc) score 8.4 — "ICICI Bank Share Price Live Updates: ICICI Bank Price Update"
- JUSTDIAL.BO (JUST DIAL LTD.) score 8.1 — "The national debt just hit $40 trillion. Here’s how it can hurt Americans."
- BHARATFORG.BO (BHARAT FORGE LTD.) score 7.4 — "Coforge shares jump 3% after IT major launches private equity unit"
- LENSKART.NS (LENSKART SOLUTIONS LTD) score 3.4 — "Lenskart Solutions among 4 stocks to hit 52-week highs & surge up to 25% in a month"
- VOLTAS.NS (VOLTAS LTD) score 2.4 — "Voltas reported strong growth in June quarter, but failed to impress"
