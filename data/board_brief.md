# Transmission Layer — board brief · 2026-08-26 16:58Z

data as of **2026-08-26** · 98 series · 13 red / 29 amber · 8 events surfaced (28 suppressed)

## Regime & assumption health (measured at generation)
- **Regime: RISK_ON** (score 0.255, 2d in regime; vol-pct 0.156, breadth-off 0.353, Markov P(high-vol) 0.012)
...
- [WEAK] **inr_oil_channel** — corr20 -0.11, corr60 -0.1, last shift 2026-07-09. Channel: oil up -> import bill -> INR weakens (usd_inr up)
- [INSUFFICIENT_DATA] **goi_ust_comove** — corr20 None, corr60 None. Channel: global duration transmits to GoI yields
- [VALID] **vix_equity_inverse** — corr20 -0.66, corr60 -0.83, last shift 2026-05-05. Channel: vol spike -> equity drawdown
...
### [RED 8.61] natgas ↑
- natgas [COMMODITIES]: last 2.91, z20 3.61, zc 1.67, resid-z 1.95 [unexplained], 1d 5.20%, 1-session move +5.20% ≥ 5.0%; |z20|=3.61
...
### [RED 5.76] commodities · 3 series ↑
- wheat [COMMODITIES]: last 740.50, z20 4.44, zc 5.24, resid-z 4.34 [unexplained], 1d 8.02%, |z20|=4.44; 1y-pct=100
- corn [COMMODITIES]: last 536.00, z20 4.15, zc 5.56, resid-z 4.49 [unexplained], 1d 7.09%, |z20|=4.15; 1y-pct=100
- soybeans [COMMODITIES]: last 1256.25, z20 2.75, zc 2.27, resid-z 2.27 [unexplained], 1d 2.30%, |z20|=2.75; 1y-pct=100
...
### [RED 5.58] dyn_dks ↓
- dyn_dks [EQUITIES]: last 128.56, z20 -3.58, zc 0.27, resid-z -1.12 [quiet], 1d 3.42%, |z20|=3.58; 1y-pct=0
...
- dyn_adanient_bo [EQUITIES]: last 3125.00, z20 3.23, zc 0.23, resid-z 0.83 [quiet], 1d 0.60%, |z20|=3.23
...
- dyn_techm_ns [EQUITIES]: last 1571.00, z20 -2.11, zc -1.20, resid-z -0.89 [quiet], 1d -1.81%, |z20|=2.11
...
### [AMBER 4.88] crypto · 2 series ↑
- btc_usd [CRYPTO]: last 78027.62, z20 2.05, zc -0.19, resid-z 0.14 [quiet], 1d -0.68%, |z20|=2.05
- eth_usd [CRYPTO]: last 2446.02, z20 1.87, zc 0.03, resid-z 0.50 [quiet], 1d 0.12%, |z20|=1.87
- **Mechanism**: crypto · 2 series ↑: correlated cluster flagged by the engine. Mechanism narrative unassessed (LLM off). Nearest historical analogue: 2026-01-06 (z-distance 0.04).
- **Gap**: Unassessed (LLM off) — laggard list above is the live math.
- **India take**: nifty_metal (rho 0.425 via btc_usd, z 2.5, reacted)
- Watch next: dxy (inverse) — not yet - watch; rho -0.578 vs eth_usd, historically leads by 1d
...
- Historical analogues: 2026-01-06 (d=0.04), 2024-09-26 (d=0.1), 2026-04-16 (d=0.11)

### [AMBER 4.75] cross-asset · 3 series ↑
- comex_copper [COMMODITIES]: last 6.70, z20 1.43, zc -0.03, resid-z 0.18 [quiet], 1d -0.07%, 1y-pct=99; co-occur[metal_copper] suppressed: channel WEAK
- dax [INDICES]: last 26314.46, z20 0.75, zc 0.24, resid-z 0.37 [quiet], 1d 0.18%, 1y-pct=97
- stoxx_50 [INDICES]: last 6474.15, z20 0.12, zc 0.38, resid-z 0.35 [quiet], 1d 0.29%, 1y-pct=96
...
- **Gap**: Unassessed (LLM off) — laggard list above is the live math.
- **India take**: nifty_midcap_100 (rho 0.521 via dax, z 1.3, reacted)
- Watch next: gold_silver_ratio (inverse) — not yet - watch; rho -0.62 vs comex_copper, historically leads by 1d
...
- **India receivers**: nifty_midcap_100 (rho 0.521, z 1.3)
...
midcap_largecap_ratio ↑ (4.73), dyn_icicigi_bo ↓ (4.48), dyn_muthootfin_ns ↑ (4.36), dyn_mrna ↑ (4.01), dyn_karurvysya_ns ↑ (3.73), indices · 2 series ↑ (3.64), comex_gold ↑ (3.63), rates · 2 series ↑ (3.39), dyn_lenskart_ns ↑ (3.28), gold_silver_ratio ↑ (3.25), dyn_stylebaaza_ns ↑ (3.15), dyn_tech ↑ (3.02)
...
- INDIANB.NS (INDIAN BANK) score 83.0 — "DEUTSCHE BANK SHARES HIT HIGHEST SINCE JULY 2011, UP 4.5%"
- INOXINDIA.NS (INOX INDIA LIMITED) score 82.2 — "India’s lower sugar quota for domestic sales failed to tame demand, says industry"
- COALINDIA.NS (COAL INDIA LTD) score 81.1 — "India’s lower sugar quota for domestic sales failed to tame demand, says industry"
- HAVELLS.NS (HAVELLS INDIA LIMITED) score 79.8 — "India’s lower sugar quota for domestic sales failed to tame demand, says industry"
- BAC (Bank of America Corporation) score 76.4 — "Bill Gates issues a stark warning about AI — and Americans increasingly share his concerns"
- HDB (HDFC Bank Limited) score 69.8 — "DEUTSCHE BANK SHARES HIT HIGHEST SINCE JULY 2011, UP 4.5%"
- IDBI.NS (IDBI BANK LIMITED) score 64.6 — "DEUTSCHE BANK SHARES HIT HIGHEST SINCE JULY 2011, UP 4.5%"
- INDUSINDBK.BO (INDUSIND BANK LTD.) score 64.6 — "DEUTSCHE BANK SHARES HIT HIGHEST SINCE JULY 2011, UP 4.5%"
- KARURVYSYA.NS (KARUR VYSYA BANK LTD) score 64.6 — "DEUTSCHE BANK SHARES HIT HIGHEST SINCE JULY 2011, UP 4.5%"
- BOND (PIMCO Active Bond Exchange-Tra) score 58.0 — "There’s so much betting against long-term bonds that a turnaround could catch investors of"
- COIN (Coinbase Global, Inc.) score 53.4 — "BILL GATES PUSHES FOR GLOBAL AI CONTROLS Bill Gates wants to meet China’s President Xi Jin"
- TECHM.NS (TECH MAHINDRA LIMITED) score 52.1 — "Hy-Tech Engineers IPO Day 3: GMP at 57%, Issue subscribed 51 times"
- CARTRADE.NS (CARTRADE TECH LIMITED) score 51.2 — "Hy-Tech Engineers IPO Day 3: GMP at 57%, Issue subscribed 51 times"
- TECH (Bio-Techne Corp) score 51.2 — "Hy-Tech Engineers IPO Day 3: GMP at 57%, Issue subscribed 51 times"
- OHI (Omega Healthcare Investors, In) score 49.4 — "Anthropic gears up for Wall Street debut: Five things investors need to know"
- LTH (Life Time Group Holdings, Inc.) score 35.8 — "TRUMP: TIME TO TEACH CANADA YOU CAN'T DO THIS ANYMORE"
- CHKP (Check Point Software Technolog) score 30.9 — "Today’s Gold Rate, Aug 26: Check gold rates in Delhi, Mumbai, Chennai"
- 301077.SZ (CHINASTARS) score 29.0 — "U.S. JUSTICE DEPARTMENT SAYS IT AND FBI SEIZE PLATFORMS OPERATED AND USED BY CHINA STATE-S"
- NVDA (NVIDIA Corporation) score 27.9 — "NVDA - NVIDIA’S $200 BILLION RISK IN FOCUS Wall Street is looking beyond Nvidia’s expected"
- JIOFIN.BO (Jio Financial Services Limited) score 21.1 — "KREMLIN ON VISIT OF CIA CHIEF TO MOSCOW: PUTIN WAS INFORMED ABOUT IT KREMLIN: TOO EARLY TO"
- STYLEBAAZA.NS (BAAZAR STYLE RETAIL LTD) score 18.8 — "Purple Style Labs opens IPO at ₹575 cap price, targets ₹680 crore fresh issue"
- MUTHOOTFIN.NS (MUTHOOT FINANCE LIMITED) score 18.0 — "Bajaj Finance Share Price Highlights: Bajaj Finance Stock Price History"
- ATHERENERG.NS (ATHER ENERGY LIMITED) score 17.8 — "UK Energy Bills to Hit Three-Year High as Gas Prices Surge"
- MS (Morgan Stanley) score 17.2 — "PRICE TARGET RAISED • $AFRM: PT raised to $80 from $79 by Morgan Stanley • $AMR: PT raised"
- PCJEWELLER.NS (PC JEWELLER LTD) score 14.5 — "Shankesh Jewellers, Sunshine Pictures make a decent debut with 2% listing gains"
- HDBFS.BO (HDB FINANCIAL SERVICES LIMITED) score 14.4 — "Piero Cipollone: From vision to delivery: building Europe’s tokenised financial market"
- META (Meta) score 14.0 — "META - META LEGAL RISK EASES, EVERCORE STAYS BULLISH Evercore ISI reiterated Outperform on"
- ADANIENT.BO (ADANI ENTERPRISES LTD.) score 13.2 — "Adani’s Cemindia is said to near up to $524 million share sale"
- TATAELXSI.NS (TATA ELXSI LIMITED) score 12.1 — "Tata Consumer Share Price Highlights: Tata Consumer Stock Price History"
- TATATECH.NS (TATA TECHNOLOGIES LIMITED) score 11.9 — "Tata Consumer Share Price Highlights: Tata Consumer Stock Price History"
- BHARATCOAL.NS (BHARAT COKING COAL LTD) score 9.0 — "Bharat Electronics shares to be in focus on Thursday as company secures  ₹730 crore order"
- ICICIGI.BO (ICICI Lombard General Insuranc) score 8.2 — "ICICI Prudential AMC shares: Prudential Corporation to divest up to 2% equity, stock up 49"
- VT (Vanguard Total World Stock Ind) score 7.1 — "Healthcare stock Park Medi World jumps 3%, rises for 5th consecutive session after this ca"
- JUSTDIAL.BO (JUST DIAL LTD.) score 6.9 — "U.S. JUSTICE DEPARTMENT SAYS IT AND FBI SEIZE PLATFORMS OPERATED AND USED BY CHINA STATE-S"
- DKS (Dick's Sporting Goods Inc) score 5.0 — "Dick’s Sporting Goods slumps after earnings miss: What’s next?"
- LENSKART.NS (LENSKART SOLUTIONS LTD) score 4.0 — "From IPO mockery to Rs 1 lakh crore m-cap: Why investors are still betting on Lenskart’s v"
- MRNA (Moderna, Inc.) score 3.8 — "Can Wolfe’s upgrade push Moderna stock higher?"
