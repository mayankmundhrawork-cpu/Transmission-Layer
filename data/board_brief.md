# Transmission Layer — board brief · 2026-09-15 19:42Z

data as of **2026-09-15** · 97 series · 23 red / 36 amber · 8 events surfaced (29 suppressed)

## Regime & assumption health (measured at generation)
- **Regime: RISK_OFF** (score 0.749, 1d in regime; vol-pct 0.616, breadth-off 0.882, Markov P(high-vol) 0.019)
...
- dyn_vt [EQUITIES]: last 157.90, z20 -2.79, zc -0.64, resid-z 0.03 [quiet], 1d -0.52%, |z20|=2.79
- dyn_ms [EQUITIES]: last 205.80, z20 -2.75, zc -0.20, resid-z -0.11 [quiet], 1d -0.38%, |z20|=2.75
- wti [COMMODITIES]: last 105.50, z20 2.56, zc 1.37, resid-z 1.03 [quiet], 1d 4.05%, 1-session move +4.05% ≥ 1.5%; |z20|=2.56; 1y-pct=97
- stoxx_50 [INDICES]: last 6237.52, z20 -2.52, zc -0.38, resid-z -0.05 [quiet], 1d -0.37%, |z20|=2.52
- sp500 [INDICES]: last 7578.17, z20 -2.42, zc -0.72, resid-z -0.05 [quiet], 1d -0.55%, |z20|=2.42
- brent [COMMODITIES]: last 108.37, z20 2.34, zc 0.86, resid-z 0.45 [quiet], 1d 2.55%, 1-session move +2.55% ≥ 1.5%; |z20|=2.34; co-occur[inr_oil] suppressed: channel WEAK
- dow_jones [INDICES]: last 52048.54, z20 -2.28, zc -0.88, resid-z -0.42 [quiet], 1d -0.71%, |z20|=2.28
- ust_30y [RATES]: last 5.35, z20 2.27, zc -0.47, resid-z -0.34 [quiet], 1d -0.37%, |z20|=2.27; 1y-pct=99
- dyn_bond [EQUITIES]: last 88.65, z20 -2.22, zc -0.31, resid-z -0.80 [quiet], 1d -0.11%, |z20|=2.22; 1y-pct=0
- russell_2000 [INDICES]: last 2869.88, z20 -2.19, zc -0.66, resid-z -0.37 [quiet], 1d -0.77%, |z20|=2.19
- vix [INDICES]: last 17.49, z20 2.19, zc 0.26, resid-z n/a [quiet], 1d 2.28%, |z20|=2.19
- nasdaq_100 [INDICES]: last 28914.55, z20 -1.97, zc -0.70, resid-z -0.62 [quiet], 1d -0.73%, |z20|=1.97
- cac_40 [INDICES]: last 8098.38, z20 -1.93, zc -0.27, resid-z 0.11 [quiet], 1d -0.24%, |z20|=1.93
- dax [INDICES]: last 25420.42, z20 -1.91, zc -0.09, resid-z 0.36 [quiet], 1d -0.08%, |z20|=1.91
- ftse_100 [INDICES]: last 10654.36, z20 -1.59, zc -0.65, resid-z -0.52 [quiet], 1d -0.40%, |z20|=1.59
...
- **India take**: nifty_it (rho 0.516 via ftse_100, z -1.12, reacted); nifty_midcap_100 (rho 0.477 via dax, z -4.2, reacted); dyn_techm_ns (rho 0.419 via ftse_100, z -0.31, quiet); midcap_largecap_ratio (rho -0.397 via ust_2y, z -0.81, quiet); nifty_50 (rho 0.385 via ftse_100, z -3.0, reacted)
...
- **India receivers**: nifty_it (rho 0.516, z -1.12); nifty_midcap_100 (rho 0.477, z -4.2); dyn_techm_ns (rho 0.419, z -0.31); midcap_largecap_ratio (rho -0.397, z -0.81)
- Source: Dollar higher as oil lifts yields and Fed hike looms — Mint Markets, 2026-09-15. https://www.livemint.com/market/dollar-higher-as-oil-lifts-yields-and-fed-hike-looms-11789500230618.html
- Source: TREASURIES-10-year note climbs to 19-year high with Fed decision on deck — Mint Markets, 2026-09-15. https://www.livemint.com/market/treasuries10year-note-climbs-to-19-year-high-with-fed-decision-on-deck-11789498155754.html
- Source: Oil jumps over $3 as Saudi export halt, Libya outages stoke supply fears — ET Markets, 2026-09-15. https://economictimes.indiatimes.com/markets/us-stocks/wall-street-guide/oil-jumps-over-3-as-saudi-export-halt-libya-outages-stoke-supply-fears/articleshow/134271731.cms
...
### [AMBER 6.21] usd_inr ↑
- usd_inr [FX]: last 95.85, z20 1.21, zc 1.48, resid-z 1.53 [unexplained], 1d 0.86%, 20d range extreme; co-occur[inr_oil] suppressed: channel WEAK
...
### [RED 5.28] dyn_jef ↓
- dyn_jef [EQUITIES]: last 48.72, z20 -3.28, zc -1.00, resid-z -1.87 [unexplained], 1d -2.75%, |z20|=3.28
...
### [AMBER 5.24] fx · 2 series ↓
- eur_usd [FX]: last 1.15, z20 -2.41, zc -1.44, resid-z -1.43 [quiet], 1d -0.42%, |z20|=2.41
- gbp_usd [FX]: last 1.35, z20 -1.76, zc -0.93, resid-z -1.05 [quiet], 1d -0.36%, |z20|=1.76
...
- **Gap**: Unassessed (LLM off) — laggard list above is the live math.
- **India take**: dyn_muthootfin_ns (rho 0.396 via gbp_usd, z -1.93, reacted); nifty_50 (rho 0.368 via eur_usd, z -3.0, reacted)
- Watch next: aud_usd (co-move) — not yet - watch; rho 0.629 vs eur_usd, historically leads by 5d
- Watch next: usd_jpy (inverse) — not yet - watch; rho -0.571 vs eur_usd, historically leads by 3d
- **India receivers**: dyn_muthootfin_ns (rho 0.396, z -1.93); nifty_50 (rho 0.368, z -3.0)
...
### [RED 4.92] dyn_bac ↓
- dyn_bac [EQUITIES]: last 59.58, z20 -2.92, zc 0.09, resid-z -0.35 [quiet], 1d 0.18%, |z20|=2.92
...
- **Gap**: Unassessed (LLM off) — laggard list above is the live math.
- **India take**: eur_inr (rho 0.366 via dyn_bac, z 0.21, quiet)
- **India receivers**: eur_inr (rho 0.366, z 0.21)
...
- nikkei_225 [INDICES]: last 63611.84, z20 -2.02, zc 0.13, resid-z 0.27 [quiet], 1d 0.19%, |z20|=2.02
...
dyn_tatatech_ns ↓ (4.39), dyn_icicigi_bo ↓ (4.18), usd_mxn ↑ (4.02), comex_gold ↓ (3.71), nifty_metal ↓ (3.5), dyn_indusindbk_bo ↓ (3.42), dyn_indianb_ns ↓ (3.34), gold_silver_ratio ↑ (3.03), dyn_lenskart_ns ↑ (3.01), dyn_hdb ↓ (2.93), asx_200 ↓ (2.86), brent_wti_spread ↓ (2.82)
...
- INOXINDIA.NS (INOX INDIA LIMITED) score 63.2 — "FPI registration in India to take five business days as Citi launches digital onboarding p"
- COALINDIA.NS (COAL INDIA LTD) score 62.7 — "FPI registration in India to take five business days as Citi launches digital onboarding p"
- HAVELLS.NS (HAVELLS INDIA LIMITED) score 61.7 — "FPI registration in India to take five business days as Citi launches digital onboarding p"
- INDIANB.NS (INDIAN BANK) score 59.2 — "FED BANK MONITORING SYSTEM HIT BY OUTAGE The Federal Reserve’s National Information Center"
- COIN (Coinbase Global, Inc.) score 53.8 — "BESSENT, ASKED ABOUT RISING BOND YIELDS ON TUESDAY, SAID THIS IS DUE TO “GLOBAL ISSUES”"
- BAC (Bank of America Corporation) score 49.9 — "FED BANK MONITORING SYSTEM HIT BY OUTAGE The Federal Reserve’s National Information Center"
- HDB (HDFC Bank Limited) score 43.4 — "FED BANK MONITORING SYSTEM HIT BY OUTAGE The Federal Reserve’s National Information Center"
- OHI (Omega Healthcare Investors, In) score 43.1 — "Top stocks in focus today: Investors must watch NBCC, BHEL, Bharat Forge shares on Wednesd"
- IDBI.NS (IDBI BANK LIMITED) score 41.2 — "FED BANK MONITORING SYSTEM HIT BY OUTAGE The Federal Reserve’s National Information Center"
- INDUSINDBK.BO (INDUSIND BANK LTD.) score 41.2 — "FED BANK MONITORING SYSTEM HIT BY OUTAGE The Federal Reserve’s National Information Center"
- KARURVYSYA.NS (KARUR VYSYA BANK LTD) score 41.2 — "FED BANK MONITORING SYSTEM HIT BY OUTAGE The Federal Reserve’s National Information Center"
- BOND (PIMCO Active Bond Exchange-Tra) score 39.3 — "BESSENT, ASKED ABOUT RISING BOND YIELDS ON TUESDAY, SAID THIS IS DUE TO “GLOBAL ISSUES”"
- CHKP (Check Point Software Technolog) score 36.4 — "Hero Motors IPO set to open; GMP signals 29% potential listing upside. Check key details"
- TECHM.NS (TECH MAHINDRA LIMITED) score 33.8 — "NHAI extends debarment to PNC Infratech; stock hits 52-week low"
- CARTRADE.NS (CARTRADE TECH LIMITED) score 33.8 — "NHAI extends debarment to PNC Infratech; stock hits 52-week low"
- TECH (Bio-Techne Corp) score 33.8 — "NHAI extends debarment to PNC Infratech; stock hits 52-week low"
- 301077.SZ (CHINASTARS) score 27.8 — "BESSENT: WE HAVE HAD GOOD PRIVATE DISCUSSIONS WITH CHINA ON IRANIAN FINANCIAL LINKS"
- SEPN (Septerna, Inc.) score 25.7 — "Stock Market prediction today: Sensex, Nifty outlook for Wed | Kospi, Taiwan Index, Nikkei"
- ATHERENERG.NS (ATHER ENERGY LIMITED) score 21.9 — "US Energy Secretary: Saudi Pipeline Could Be Back in Service Within Days"
- LTH (Life Time Group Holdings, Inc.) score 20.3 — "Can The Power Grid Handle AI And Wildfires At The Same Time?"
- TATAELXSI.NS (TATA ELXSI LIMITED) score 12.6 — "Afcons Infra stock surges on Tata Sons listing hopes. Is a re-rating on the cards?"
- TATATECH.NS (TATA TECHNOLOGIES LIMITED) score 12.6 — "Afcons Infra stock surges on Tata Sons listing hopes. Is a re-rating on the cards?"
- JUSTDIAL.BO (JUST DIAL LTD.) score 10.1 — "TRUMP BLASTS SUPREME COURT OVER MAJOR RULINGS President Trump sharply criticized the U.S. "
- STYLEBAAZA.NS (BAAZAR STYLE RETAIL LTD) score 8.8 — "Indian government allocates record sugar sales quota for September to rein in retail price"
- NVDA (NVIDIA Corporation) score 8.6 — "NVIDIA, Palantir and Booz Allen Hamilton will limit use of ANTHROPIC models"
- JIOFIN.BO (Jio Financial Services Limited) score 8.4 — "BESSENT: WE HAVE HAD GOOD PRIVATE DISCUSSIONS WITH CHINA ON IRANIAN FINANCIAL LINKS"
- VT (Vanguard Total World Stock Ind) score 6.9 — "BESSENT SAYS U.S. BOND MARKET IS THE BEST-PERFORMING IN THE WORLD"
- MS (Morgan Stanley) score 6.6 — "Global Market: Morgan Stanley turns hawkish, sees two Fed rate hikes in 2026"
- PCJEWELLER.NS (PC JEWELLER LTD) score 6.6 — "All that glitters... in jewellers’ IPO boom"
- MUTHOOTFIN.NS (MUTHOOT FINANCE LIMITED) score 6.4 — "BESSENT SAYS WE HAVE SEEN SOME FORWARD FACING STATEMENTS FROM UNITED ARAB EMIRATES TO CUT "
- JEF (Jefferies Financial Group Inc.) score 6.0 — "HDFC Bank share price target: What are Jefferies, 3 other foreign brokerages saying as CEO"
- BZ=F (Brent Crude Oil Last Day Finan) score 6.0 — "TRUMP BLASTS SUPREME COURT OVER MAJOR RULINGS President Trump sharply criticized the U.S. "
- ADANIENT.BO (ADANI ENTERPRISES LTD.) score 5.9 — "Tech picks: Adani Ports, Data Patterns among 5 stocks that could give up to 23% returns in"
- 4417.T (GLOBAL SECURITY EXPERTS INC) score 4.7 — "HDFC Bank share price jumps over 6% in 3 days | Experts see 15% more upside, check target "
- ICICIGI.BO (ICICI Lombard General Insuranc) score 4.5 — "ICICI Prudential MF, Kotak MF top buyers in SS Retail's Rs 146 crore anchor round before I"
- META (Meta) score 4.1 — "Gold and silver prices crash up to 2% on MCX- What is driving precious metals down?"
